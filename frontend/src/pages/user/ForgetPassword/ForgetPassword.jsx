      ...
      <div style={styles.card}>
          ...
          <div style={styles.formContainer}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={styles.form}>
              ...
              <button type="submit" disabled={isSubmitting} style={styles.loginBtn}>
                {isSubmitting ? <span style={styles.spinner} /> : "Send OTP"}
              </button>
            </form>
        ...
        <div style={styles.rightPanel}>
          ...
          <div style={styles.rightContent}>
            <h1 style={styles.rightTitle}>Reset your<br/>password</h1>
            <p style={styles.rightSubtitle}>We'll help you get back to your account securely</p>
