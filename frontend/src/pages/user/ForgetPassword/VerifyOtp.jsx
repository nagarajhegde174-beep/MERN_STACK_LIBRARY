      ...
      <div style={styles.card}>
          ...
          <div style={styles.formContainer}>
            <div style={styles.header}>
              ...
              <p style={styles.subtitle}>
                ...
                <span style={{ color: "#AA78F8", fontWeight: "600" }}>{email}</span>
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={styles.form}>
              ...
              <div style={styles.fieldGroup}>
                ...
                />
                {errors.otp && <span style={styles.error}>{errors.otp.message}</span>}
              </div>

              {/* Verify OTP Button */}
              <button type="submit" disabled={isSubmitting} style={styles.loginBtn}>
                {isSubmitting ? <span style={styles.spinner} /> : "Verify OTP"}
              </button>
            </form>
        ...
        <div style={styles.rightPanel}>
          ...
          <div style={styles.rightContent}>
            <h1 style={styles.rightTitle}>Security<br/>Check</h1>
            <p style={styles.rightSubtitle}>Please verify your identity to continue</p>
            
            <div style={styles.imgWrapper}>
              <img src="/purple-student-illustration.png" alt="Verify OTP Illustration" style={styles.illustration} />
            </div>
          </div>
        </div>
